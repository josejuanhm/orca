...
CONFIG.SYNCHRONIZATION_STAGES {2} \
  ...
  set idram_0 [ create_bd_cell -type ip -vlnv vectorblox.com:user:idram:1.0 idram_0 ]
  set_property -dict [ list \
CONFIG.SIZE {262144} \
 ] $idram_0
...
CONFIG.INSTRUCTION_REQUEST_REGISTER {0} \
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins axi_interconnect_memory/S03_AXI] [get_bd_intf_pins orca/DC]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins idram_0/instr]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_memory_M00_AXI [get_bd_intf_pins axi_interconnect_memory/M00_AXI] [get_bd_intf_pins idram_0/data]
  ...
  connect_bd_intf_net -intf_net orca_IC [get_bd_intf_pins axi_interconnect_0/S01_AXI] [get_bd_intf_pins orca/IC]
  connect_bd_intf_net -intf_net orca_IUC [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins orca/IUC]
  ...
  connect_bd_intf_net -intf_net ps7_uart_monitor_M_AXI [get_bd_intf_pins axi_interconnect_A4L_to_A4_PS7_GP0/S00_AXI] [get_bd_intf_pins ps7_uart_monitor/M_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_jtag/ARESETN] [get_bd_pins clock/interconnect_aresetn_jtag]
  connect_bd_net -net clock_clk_out [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/ACLK] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/M00_ACLK] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/S00_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/ACLK] [get_bd_pins axi_interconnect_data_uncacheable/M00_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/M01_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/M02_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/M03_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/S00_ACLK] [get_bd_pins axi_interconnect_data_uncacheable/S01_ACLK] [get_bd_pins axi_interconnect_jtag/ACLK] [get_bd_pins axi_interconnect_jtag/M00_ACLK] [get_bd_pins axi_interconnect_jtag/M01_ACLK] [get_bd_pins axi_interconnect_jtag/S00_ACLK] [get_bd_pins axi_interconnect_memory/ACLK] [get_bd_pins axi_interconnect_memory/M00_ACLK] [get_bd_pins axi_interconnect_memory/S00_ACLK] [get_bd_pins axi_interconnect_memory/S01_ACLK] [get_bd_pins axi_interconnect_memory/S02_ACLK] [get_bd_pins axi_interconnect_memory/S03_ACLK] [get_bd_pins clock/clk_out] [get_bd_pins dummy/clk_in] [get_bd_pins idram_0/clk] [get_bd_pins jtag_axi/aclk] [get_bd_pins orca/clk] [get_bd_pins orca_timer/clk] [get_bd_pins ps7_uart_monitor/axi_aclk]
  connect_bd_net -net clock_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/ARESETN] [get_bd_pins axi_interconnect_memory/ARESETN] [get_bd_pins clock/interconnect_aresetn]
  connect_bd_net -net clock_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/M00_ARESETN] [get_bd_pins axi_interconnect_A4L_to_A4_PS7_GP0/S00_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/M00_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/M01_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/M02_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/M03_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/S00_ARESETN] [get_bd_pins axi_interconnect_data_uncacheable/S01_ARESETN] [get_bd_pins axi_interconnect_jtag/M01_ARESETN] [get_bd_pins axi_interconnect_memory/M00_ARESETN] [get_bd_pins axi_interconnect_memory/S00_ARESETN] [get_bd_pins axi_interconnect_memory/S01_ARESETN] [get_bd_pins axi_interconnect_memory/S02_ARESETN] [get_bd_pins axi_interconnect_memory/S03_ARESETN] [get_bd_pins clock/peripheral_aresetn] [get_bd_pins ps7_uart_monitor/axi_aresetn]
  connect_bd_net -net clock_peripheral_aresetn_jtag [get_bd_pins axi_interconnect_jtag/M00_ARESETN] [get_bd_pins axi_interconnect_jtag/S00_ARESETN] [get_bd_pins clock/peripheral_aresetn_jtag] [get_bd_pins jtag_axi/aresetn]
  connect_bd_net -net clock_peripheral_reset_cpu [get_bd_pins clock/peripheral_reset_cpu] [get_bd_pins idram_0/reset] [get_bd_pins orca/reset] [get_bd_pins orca_timer/reset]
  connect_bd_net -net dummy_clk_out [get_bd_pins dummy/clk_out] [get_bd_pins processing_system7/S_AXI_GP0_ACLK] [get_bd_pins processing_system7/S_AXI_HP0_ACLK]
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces jtag_axi/Data] [get_bd_addr_segs idram_0/data/reg0] SEG_idram_0_reg0
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces orca/DUC] [get_bd_addr_segs idram_0/data/reg0] SEG_idram_0_reg0
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces orca/IC] [get_bd_addr_segs idram_0/instr/reg0] SEG_idram_0_reg0
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces orca/DC] [get_bd_addr_segs idram_0/data/reg0] SEG_idram_0_reg0
  create_bd_addr_seg -range 0x00020000 -offset 0x00000000 [get_bd_addr_spaces orca/IUC] [get_bd_addr_segs idram_0/instr/reg0] SEG_idram_0_reg0
